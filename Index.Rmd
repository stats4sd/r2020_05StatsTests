...
So, if we think back to our `Pulse` dataset - we could compare perceived attractiveness of the respondents, `Attractiveness`,  gender, `Gender`. We should always start by exploring our data first!
